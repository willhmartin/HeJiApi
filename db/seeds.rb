...
trip1 = Trip.create!(title: "Sanya Trip", location: "Sanya", start_date: Date.today, end_date: Date.today)
trip2 = Trip.create(title: "New York Trip", location: "New York City", start_date: Date.today, end_date: Date.today)
trip3 = Trip.create(title: "Patagonia Trip", location: "Chile", start_date: Date.today, end_date: Date.today)
